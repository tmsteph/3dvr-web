...
test('homepage ships Gun-backed experiment and feedback plumbing', async () => {
  ...
  assert.match(html, /data-growth-cta="open-calendar-hub"/);
  ...
  assert.match(html, /data-growth-cta="open-calendar-hub"[^>]+data-portal-path="\/calendar\/"/);
  ...
  assert.match(html, /href="https:\/\/portal\.3dvr\.tech\/calendar\/"/);
